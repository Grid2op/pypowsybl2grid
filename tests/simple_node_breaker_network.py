...
def create_simple_node_breaker_network() -> Network:
    ...
    substations = pd.DataFrame.from_records(
        index="id", data=[{"id": "S1"}, {"id": "S2"}, {"id": "S3"}]
    )
    ...
    busbar_sections = pd.DataFrame.from_records(
        index="id",
        data=[
    ...
    pp.network.create_coupling_device(
        network,
        switch_prefix_id="COUPLER1",
        bus_or_busbar_section_id_1=["BBS1A"],
        ...
        data=[
            {
                ...
                "p0": 10.0,
                "q0": 3.0,
                "bus_or_busbar_section_id": "BBS1B",
                "position_order": 1,
                "direction": "BOTTOM",
            },
            {
        ...
        data=[
            {
                ...
                "target_q": 0,
                "target_v": 403,
                "bus_or_busbar_section_id": "BBS1A",
                "position_order": 1,
            }
        ],
    )
    ...
    lines = pd.DataFrame.from_records(
        ...
        data=[
            ...
            },
            {
                ...
                "g2": 0,
                "b2": 0,
                "bus_or_busbar_section_id_1": "BBS1B",
                "position_order_1": 2,
                "direction_1": "BOTTOM",
                "bus_or_busbar_section_id_2": "BBS3",
                "position_order_2": 2,
                "direction_2": "TOP",
            },
            {
                ...
                "g2": 0,
                "b2": 0,
                "bus_or_busbar_section_id_1": "BBS2",
                "position_order_1": 3,
                "direction_1": "TOP",
                "bus_or_busbar_section_id_2": "BBS3",
                "position_order_2": 3,
